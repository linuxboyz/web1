<?php /* Smarty version 2.6.11, created on 2013-06-21 12:59:36
         compiled from modules/Campaigns/tpls/WizardCampaignTargetListForNonNewsLetter.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'modules/Campaigns/tpls/WizardCampaignTargetListForNonNewsLetter.tpl', 157, false),array('function', 'sugar_getimage', 'modules/Campaigns/tpls/WizardCampaignTargetListForNonNewsLetter.tpl', 158, false),)), $this); ?>
...
>
	...
	<tr>
	<th colspan="5" align="left" ><h4><?php echo $this->_tpl_vars['MOD']['LBL_TARGET_LISTS']; ?>
</h4></th>
	</tr>
	<tr>
	<td colspan="5"><?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_TARGET_MESSAGE1']; ?>
<br></td>
	</tr>
	<tr><td colspan=5>&nbsp;</td></tr>
	<tr>
	<td scope="row" colspan="4"><?php echo $this->_tpl_vars['MOD']['LBL_SELECT_TARGET']; ?>
&nbsp;
...
, "single", true);'>
	...
	<tr><td colspan=5>&nbsp;</td></tr>
	<tr>
	<td scope="row" colspan="5"><?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_TARGET_MESSAGE2']; ?>
<br></td>
	</tr>
	<tr>
	<td width='10%' scope="col"><?php echo $this->_tpl_vars['MOD']['LBL_TARGET_NAME']; ?>
</td>
	<td width='20%'>
	...
	<table width = '100%' class='detail view'>
		...
		<tr><td>
			...
			<table border=1 width='100%'><tr class='detail view'>
				<th scope='col' width='25%'><b><?php echo $this->_tpl_vars['MOD']['LBL_TARGET_NAME']; ?>
</b></th>
			    <th scope='col' width='25%'><b><?php echo $this->_tpl_vars['MOD']['LBL_TARGET_TYPE']; ?>
</b></th><td>&nbsp;</td>
			    <td width='25%'><b>&nbsp;</b></td>
		    </tr>
			</table>
...
//                    trgt_type_text_value = trgt_type.options[selInd].text
					...
					//display the html
					<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DELETE','module' => 'CAMPAIGNS'), $this); $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('alt_remove', ob_get_contents());ob_end_clean(); ?>
                    var trgt_html = "<div id='trgt_added_"+targets_added+"'> <table width='100%' class='tabDetailViewDL2'><tr class='tabDetailViewDL2' ><td width='25%'>"+trgt_name_html+"</td><td width='25%'>"+trgt_type_html+"</td><td>"+trgt_id_html+"<a href='#' onclick=\"remove_target('trgt_added_"+targets_added+"','"+targets_added+"'); \" >  "+'<?php echo smarty_function_sugar_getimage(array('name' => 'delete_inline','ext' => ".gif",'width' => '12','height' => '12','alt' => $this->_tpl_vars['alt_remove'],'other_attributes' => 'align="absmiddle" border="0" '), $this);?>
