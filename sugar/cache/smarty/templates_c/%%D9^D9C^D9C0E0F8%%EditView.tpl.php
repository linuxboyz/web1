<?php /* Smarty version 2.6.11, created on 2013-07-01 11:57:09
         compiled from cache/modules/Campaigns/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Campaigns/EditView.tpl', 44, false),array('function', 'counter', 'cache/modules/Campaigns/EditView.tpl', 50, false),array('function', 'sugar_getimagepath', 'cache/modules/Campaigns/EditView.tpl', 53, false),array('function', 'sugar_translate', 'cache/modules/Campaigns/EditView.tpl', 56, false),array('function', 'html_options', 'cache/modules/Campaigns/EditView.tpl', 100, false),array('function', 'sugar_getimage', 'cache/modules/Campaigns/EditView.tpl', 323, false),array('function', 'sugar_number_format', 'cache/modules/Campaigns/EditView.tpl', 638, false),array('modifier', 'default', 'cache/modules/Campaigns/EditView.tpl', 49, false),array('modifier', 'strip_semicolon', 'cache/modules/Campaigns/EditView.tpl', 67, false),array('modifier', 'lookup', 'cache/modules/Campaigns/EditView.tpl', 125, false),array('modifier', 'count', 'cache/modules/Campaigns/EditView.tpl', 205, false),)), $this); ?>
...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=Campaigns'); return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_CAMPAIGN_TYPE','module' => 'Campaigns'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<script type="text/javascript" src="include/javascript/popup_parent_helper.js?v=V08vsEsWBmz8-80-P2bkOg"></script>
<script type="text/javascript">
...
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'Campaigns','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'assigned_user_id\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'Campaigns','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'Campaigns','for_js' => true), $this); echo '\' );
...
addToValidateDateBefore(\'EditView\', \'start_date\', \'date\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CAMPAIGN_START_DATE','module' => 'Campaigns','for_js' => true), $this); echo '\', \'end_date\' );
addToValidate(\'EditView\', \'end_date\', \'date\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CAMPAIGN_END_DATE','module' => 'Campaigns','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'status\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CAMPAIGN_STATUS','module' => 'Campaigns','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'currency_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENCY','module' => 'Campaigns','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'campaign_type\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CAMPAIGN_TYPE','module' => 'Campaigns','for_js' => true), $this); echo '\' );
