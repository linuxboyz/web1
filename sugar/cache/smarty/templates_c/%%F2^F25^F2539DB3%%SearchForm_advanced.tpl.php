<?php /* Smarty version 2.6.11, created on 2013-06-21 13:33:25
         compiled from cache/modules/Campaigns/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Campaigns/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/modules/Campaigns/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/Campaigns/SearchForm_advanced.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/Campaigns/SearchForm_advanced.tpl', 44, false),array('function', 'html_options', 'cache/modules/Campaigns/SearchForm_advanced.tpl', 93, false),array('function', 'sugar_getimage', 'cache/modules/Campaigns/SearchForm_advanced.tpl', 100, false),array('modifier', 'default', 'cache/modules/Campaigns/SearchForm_advanced.tpl', 109, false),)), $this); ?>
...
<?php if (isset ( $_REQUEST['start_date_advanced_range_choice'] )):  $this->assign('starting_choice', $_REQUEST['start_date_advanced_range_choice']);  else:  $this->assign('starting_choice', "=");  endif; ?>
...
" value='<?php if (empty ( $_REQUEST['range_start_date_advanced'] ) && ! empty ( $_REQUEST['start_date_advanced'] )):  echo $_REQUEST['start_date_advanced'];  else:  echo $_REQUEST['range_start_date_advanced'];  endif; ?>' title=''   size="11" style="width:100px !important;">
...
<?php if (isset ( $_REQUEST['end_date_advanced_range_choice'] )):  $this->assign('starting_choice', $_REQUEST['end_date_advanced_range_choice']);  else:  $this->assign('starting_choice', "=");  endif; ?>
...
<input autocomplete="off" type="text" name="range_<?php echo $this->_tpl_vars['id']; ?>
" id="range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php if (empty ( $_REQUEST['range_end_date_advanced'] ) && ! empty ( $_REQUEST['end_date_advanced'] )):  echo $_REQUEST['end_date_advanced'];  else:  echo $_REQUEST['range_end_date_advanced'];  endif; ?>' title=''   size="11" style="width:100px !important;">
<?php ob_start(); ?>alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['id']; ?>
_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean();  echo smarty_function_sugar_getimage(array('name' => 'jscalendar','ext' => ".gif",'other_attributes' => ($this->_tpl_vars['other_attributes'])), $this);?>
