...
// 2011-03-25 added function to be evaluated
    ...
    function build_query_strings() {
        ...
        if ($this->union_modules != '') {
            ...
            $this->buildTotalSelectString($queryString);
...
//                $sortArray['1'][] = $this->sortOverride['sortid'] . ' ' . strtoupper($this->sortOverride['sortseq']);
                // $sortArray['1'][] = $this->get_field_name($this->get_fieldname_by_fieldid($this->sortOverride['sortid']), $this->get_fieldpath_by_fieldid($this->sortOverride['sortid']), $this->sortOverride['sortid']) . ' ' . strtoupper($this->sortOverride['sortseq']);
