...
addToValidate('EditView', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='Campaigns' for_js=true}{literal}' );
...
addToValidate('EditView', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='Campaigns' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='Campaigns' for_js=true}{literal}' );
...
addToValidateDateBefore('EditView', 'start_date', 'date', false,'{/literal}{sugar_translate label='LBL_CAMPAIGN_START_DATE' module='Campaigns' for_js=true}{literal}', 'end_date' );
addToValidate('EditView', 'end_date', 'date', true,'{/literal}{sugar_translate label='LBL_CAMPAIGN_END_DATE' module='Campaigns' for_js=true}{literal}' );
addToValidate('EditView', 'status', 'enum', true,'{/literal}{sugar_translate label='LBL_CAMPAIGN_STATUS' module='Campaigns' for_js=true}{literal}' );
...
addToValidate('EditView', 'currency_id', 'id', false,'{/literal}{sugar_translate label='LBL_CURRENCY' module='Campaigns' for_js=true}{literal}' );
...
addToValidate('EditView', 'campaign_type', 'enum', true,'{/literal}{sugar_translate label='LBL_CAMPAIGN_TYPE' module='Campaigns' for_js=true}{literal}' );
